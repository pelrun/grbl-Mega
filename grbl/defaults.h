...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_Z_STEPS_PER_MM 40
  #define DEFAULT_X_MAX_RATE 20000 // mm/min
  #define DEFAULT_Y_MAX_RATE 10000 // mm/min
  #define DEFAULT_Z_MAX_RATE 20000 // mm/min
  #define DEFAULT_X_ACCELERATION (3000.0*60*60)
  #define DEFAULT_Y_ACCELERATION (500.0*60*60)
  #define DEFAULT_Z_ACCELERATION (3000.0*60*60)
  #define DEFAULT_X_MAX_TRAVEL 200.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 200.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 40.0 // mm
  #define DEFAULT_SPINDLE_RPM_MAX 0.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
